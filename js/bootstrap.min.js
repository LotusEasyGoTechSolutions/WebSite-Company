...
//   // Reset background for all category items
//   document.querySelectorAll('.category-item').forEach(item => item.classList.remove('active'));

//   // Set the selected category item as active
//   document.querySelector(`.category-item:nth-child(${id})`).classList.add('active');

//   // Display the details section
//   const detailsContainer = document.getElementById('details');
//   detailsContainer.classList.add('active');

//   // Update the text based on the selected category
//   const detailsText = document.getElementById('details-text');
//   switch (id) {
//       case 1:
//           detailsText.innerHTML = "Details about Apparel & Footwear";
//           break;
//       case 2:
//           detailsText.innerHTML = "Details about Electrical, Electronics & Computers";
//           break;
//       case 3:
//           detailsText.innerHTML = "Details about Hypermarket & Departmental Stores";
//           break;
//       case 4:
//           detailsText.innerHTML = "Details about Lifestyle & Fashion";
//           break;
//       case 5:
//           detailsText.innerHTML = "Details about Pharma & Healthcare";
//           break;
//       case 6:
//           detailsText.innerHTML = "Details about Supermarket & Groceries";
//           break;
//       case 7:
//           detailsText.innerHTML = "Details about Specialized Retail";
//           break;
//       default:
...
function showDetails(id) {
  ...
  // Update the main text based on the selected category
  const detailsText = document.getElementById('details-text');
  const subContent = document.getElementById('sub-content');
  subContent.innerHTML = ""; // Clear previous content

  let subItems = []; // Array to hold grid items for each category
  switch (id) {
    case 1:
      subItems = [
        { icon: "./assets/images/a1.png", label: "Apparel & Footwear", url: "terms.html" },
        { icon: "./assets/images/a7.png", label: "Shoes", url: "shoes.html" },
        { icon: "./assets/images/a5.png", label: "Footwear", url: "footwear.html" },
        { icon: "./assets/images/a4.png", label: "Boutiques", url: "boutiques.html" },
        { icon: "./assets/images/a3.png", label: "Fancy Costume", url: "fancy-costume.html" },
        { icon: "./assets/images/a6.png", label: "Apparel & Clothing", url: "apparel-clothing.html" },
        { icon: "./assets/images/a2.png", label: "Textile", url: "textile.html" },
        { icon: "./assets/images/a8.png", label: "Readymade Garment", url: "readymade-garment.html" }
      ];      
      break;
    case 2:
      subItems = [
        { icon: "./assets/images/e1.png", label: "Camera & Accessories" },
        { icon: "./assets/images/e2.png", label: "Computer Hardware" },
        { icon: "./assets/images/e3.png", label: "Electrical, Electronics & Computers" },
        { icon: "./assets/images/e4.png", label: "Electrical" },
        { icon: "./assets/images/e5.png", label: "Electronics" },
        { icon: "./assets/images/e6.png", label: "Home Appliances" },
        { icon: "./assets/images/e7.png", label: "Mobile Phone & Accessories" },
        { icon: "./assets/images/e8.png", label: "Videos & Games Accessories" },
      ];
      break;
    case 3:
      subItems = [
        { icon: "./assets/images/h1.png", label: "Convenience Store" },
        { icon: "./assets/images/h2.png", label: "Hypermarket" },
        { icon: "./assets/images/h4.png", label: "Hypermarket & Department Stores" },
        { icon: "./assets/images/h3.png", label: "Department Store" }
      ];
      break;
    case 4:
      subItems = [
        { icon: "./assets/images/l1.png", label: "Beauty Parlour, SPA, Salon" },
        { icon: "./assets/images/l2.png", label: "Beauty & Cosmetics" },
        { icon: "./assets/images/l3.png", label: "Books Shop" },
        { icon: "./assets/images/l4.png", label: "Books & Publishing" },
        { icon: "./assets/images/l5.png", label: "Fashion Jewelry" },
        { icon: "./assets/images/l6.png", label: "Fancy Store" },
        { icon: "./assets/images/l7.png", label: "Florists" },
        { icon: "./assets/images/l8.png", label: "Glass & Crockeries" },
        { icon: "./assets/images/l9.png", label: "Home Decor & Furniture" },
        { icon: "./assets/images/l10.png", label: "Lifestyle & Fashion" },
        { icon: "./assets/images/l11.png", label: "Luggage & Bags" },
        { icon: "./assets/images/l12.png", label: "Music & Movies" },
        { icon: "./assets/images/l13.png", label: "Opticals" },
        { icon: "./assets/images/l14.png", label: "Photo Shop" },
        { icon: "./assets/images/l15.png", label: "Staionery Shop" },
        { icon: "./assets/images/l16.png", label: "Toys, Baby Shops & Kids Fashion" },
        { icon: "./assets/images/l17.png", label: "Watches" }
      ];
      break;
    case 5:
      subItems = [
        { icon: "./assets/images/p1.png", label: "Ayruvedic & Wellness" },
        { icon: "./assets/images/p2.png", label: "Chemists & Drggists" },
        { icon: "./assets/images/p3.png", label: "Health Care" },
        { icon: "./assets/images/p4.png", label: "Medical Shop" },
        { icon: "./assets/images/p5.png", label: "Pharmacy" },
        { icon: "./assets/images/p6.png", label: "Surgical" }
      ];
      break;
    case 6:
      subItems = [
        { icon: "./assets/images/g1.png", label: "Fruits & Vegetables" },
        { icon: "./assets/images/g2.png", label: "Groceries & Vegetables" },
        { icon: "./assets/images/g3.png", label: "Rice Traders" },
        { icon: "./assets/images/g4.png", label: "Supermarket" }
      ];
      break;
    case 7:
      subItems = [
        { icon: "./assets/images/s1.png", label: "Auto Parts" },
        { icon: "./assets/images/s2.png", label: "Fertilizer & Agro Products" },
        { icon: "./assets/images/s3.png", label: "Gifts & Greeting Cards" },
        { icon: "./assets/images/s4.png", label: "Hardware" },
        { icon: "./assets/images/s5.png", label: "Specialized Retail" },
        { icon: "./assets/images/s6.png", label: "Sports & Fitness/Sportswear" },
        { icon: "./assets/images/s7.png", label: "Tyre" },
        { icon: "./assets/images/s8.png", label: "Vessel Shop" },
        { icon: "./assets/images/s9.png", label: "Pet Shop" }
      ];
      break;
    default:
      detailsText.innerHTML = "Select a category to view details";
  }

  // Populate the sub-content grid with items
  subItems.forEach(item => {
    const subItemDiv = document.createElement('div');
    subItemDiv.className = 'sub-content-item';
    ...
    subItemDiv.appendChild(iconImg);
    subItemDiv.appendChild(labelSpan);
    subContent.appendChild(subItemDiv);
  });
}
